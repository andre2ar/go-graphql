...
func (ec *executionContext) field_Mutation_createCourse_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalONewCourse2ᚖgoᚑgraphqlᚋgraphᚋmodelᚐNewCourse(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalONewCourse2ᚖgoᚑgraphqlᚋgraphᚋmodelᚐNewCourse(ctx context.Context, v interface{}) (*model.NewCourse, error) {
	if v == nil {
		return nil, nil
	}
