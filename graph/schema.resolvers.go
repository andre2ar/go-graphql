...
func (r *categoryResolver) Courses(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
	courses, err := r.CourseRepository.FindByCategoryID(obj.ID)
	if err != nil {
		return nil, err
	}
...
func (r *mutationResolver) CreateCategory(ctx context.Context, input model.NewCategory) (*model.Category, error) {
	category, err := r.CategoryRepository.Create(input.Name, *input.Description)
	if err != nil {
		return nil, err
	}
...
func (r *mutationResolver) CreateCourse(ctx context.Context, input *model.NewCourse) (*model.Course, error) {
	course, err := r.CourseRepository.Create(input.Name, *input.Description, input.CategoryID)
	if err != nil {
		return nil, err
	}
	return &model.Course{
...
func (r *queryResolver) Categories(ctx context.Context) ([]*model.Category, error) {
	categories, err := r.CategoryRepository.FindAll()
	if err != nil {
		return nil, err
	}
...
func (r *queryResolver) Courses(ctx context.Context) ([]*model.Course, error) {
	courses, err := r.CourseRepository.FindAll()
	if err != nil {
		return nil, err
	}
	var coursesModel []*model.Course
